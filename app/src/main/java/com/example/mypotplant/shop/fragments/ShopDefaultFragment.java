 ...
 * @since 1.0
 */
public class ShopDefaultFragment extends LazyBaseFragment {
    ...
    public ShopDefaultFragment(){}

    public static ShopDefaultFragment newInstance(String topic){
        ShopDefaultFragment fragment=new ShopDefaultFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.fragment_shop_default,container,false);
        return view;
    }
